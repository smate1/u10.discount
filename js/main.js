...
const galleries = {
	...
	red: [
		...
		},
		{
			...
			srcset: './assets/images/red-2.webp 1x, ./assets/images/red-2@2x.webp 2x',
			sizes: '(max-width: 768px) 100vw, 50vw',
			alt: 'Red version 2',
		},
		{
			...
			srcset: './assets/images/red-3.webp 1x, ./assets/images/red-3@2x.webp 2x',
			sizes: '(max-width: 768px) 100vw, 50vw',
			alt: 'Red version 3',
		},
		{
			...
			srcset: './assets/images/red-4.jpg 1x, ./assets/images/red-4@2x.jpg 2x',
			sizes: '(max-width: 768px) 100vw, 50vw',
			alt: 'Red version 4',
		},
	],
